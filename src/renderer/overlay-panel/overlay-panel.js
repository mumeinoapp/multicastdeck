...
// 2026-08-08（段階D）: 配信チェック（統一フィード）関連コードは撤去済み。当該機能は独立
// BrowserWindow方式（src/renderer/stream-check-window/配下、main.jsのcreateStreamCheckWindow）
// へ完全移行済みのため、このオーバーレイパネル基盤（help/welcome/premium-locked/feedback/
// pro-authの5モーダルが引き続き使用中）からは撤去した。
